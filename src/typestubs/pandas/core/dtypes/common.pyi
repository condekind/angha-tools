...
import numpy as np
from pandas.compat import binary_type, text_type
from pandas._libs import algos

""" common type operations """
_POSSIBLY_CAST_DTYPES = set([np.dtype(t).name for t in ['O', 'int8', 'uint8', 'int16', 'uint16', 'int32', 'uint32', 'int64', 'uint64']])
...
_string_dtypes = frozenset(map(_get_dtype_from_object, (binary_type, text_type)))
